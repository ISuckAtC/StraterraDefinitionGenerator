public partial class Program
{
    ...
    static void WriteTownBuildings(string[][] values)
    {
        ...
        for (int i = 0; i < 23; ++i)
        {
            ...
            townBuilding.foodCost = int.Parse(values[i][2]);
            townBuilding.woodCost = int.Parse(values[i][3]);
            townBuilding.metalCost = int.Parse(values[i][4]);
            townBuilding.orderCost = int.Parse(values[i][5]);
            townBuilding.buildingTime = int.Parse(values[i][6]);
            townBuilding.level = byte.Parse(values[i][7]);
            townBuilding.maxLevel = byte.Parse(values[i][8]);
            townBuilding.name = values[i][9];
            townBuilding.health = int.Parse(values[i][10]);
