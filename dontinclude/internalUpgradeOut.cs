InternalUpgrade?[] internalUpgrades = new InternalUpgrade?[256];
System.Array.Fill(internalUpgrades, null);
...
storage0.id = 0;
storage0.type = UpgradeTypes.STORAGE;
...
storage1.orderMax = -1;
storage1.id = 1;
storage1.type = UpgradeTypes.STORAGE;
...
storage2.orderMax = -1;
storage2.id = 2;
storage2.type = UpgradeTypes.STORAGE;
...
storage3.orderMax = -1;
storage3.id = 3;
storage3.type = UpgradeTypes.STORAGE;
...
storage11.id = 11;
storage11.type = UpgradeTypes.STORAGE;
...
storage12.id = 12;
storage12.type = UpgradeTypes.STORAGE;
...
storage13.id = 13;
storage13.type = UpgradeTypes.STORAGE;
...
storage21.id = 21;
storage21.type = UpgradeTypes.STORAGE;
...
storage22.id = 22;
storage22.type = UpgradeTypes.STORAGE;
